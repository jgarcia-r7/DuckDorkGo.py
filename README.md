...
Anyways, you run it against a domain, it scrapes for the filetypes specified (common ones set by default), downloads all of em, scrapes for useful metadata, and makes you a nice easy CSV - yes easy for reports too.
